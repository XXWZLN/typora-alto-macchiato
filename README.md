...
<p align="center">为中文笔记与技术写作而作的 Typora 深色主题。</p>
...
![中文正文与标题排版](image/README/1789977255163.png)

Macchiato 的低饱和配色，搭配霞鹜文楷的中文正文与 Maple Mono 的等宽代码。适合写阅读笔记、整理技术文章。

## 格式展示

![Alto Macchiato：表格、JavaScript 代码、数学公式与 Mermaid 流程图](image/README/1789977332285.png)
